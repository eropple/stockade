// This is sourced from the `http-status-codes` NPM library, converted to TypeScript.
// `http-status-codes` is MIT licensed.
//
 ...
 * HTTP method: GET: The resource has been fetched and is transmitted in the
 * message body. HEAD: The entity headers are in the message body. POST: The
 * resource describing the result of the action is transmitted in the message
 * body. TRACE: The message body contains the request message as received by the
 * server
 */
OK = 200,
/**
